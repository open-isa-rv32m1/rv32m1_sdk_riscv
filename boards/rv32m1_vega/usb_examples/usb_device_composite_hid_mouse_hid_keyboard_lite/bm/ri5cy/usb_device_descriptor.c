...
USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceHidMouseReportDescriptor[]);
...
USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceHidKeyboardReportDescriptor[]);
...
USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceQualifierDescriptor[]);
...
USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceString3[]);
...
USB_RAM_ADDRESS_NONCACHEREG(uint8_t g_UsbDeviceString4[]);
