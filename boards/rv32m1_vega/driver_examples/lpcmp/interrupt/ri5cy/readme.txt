...
Board settings
==============
This example project uses LPCMP instance 0(M4) or instance 1(M0) to compare the voltage signal input from channel 2
...
- Input signal to J2-18(PTC9) when using LPCMP instance 0(M4)
- Input signal to J4-9(PTE5)  when using LPCMP instance 1(M0)
