...
void BOARD_InitPins(void) {
  ...
  const port_pin_config_t porte29_pinG15_config = {
    ...
    kPORT_MuxAlt7,                                           /* Pin is configured as FXIO0_D30 */
    kPORT_UnlockRegister                                     /* Pin Control Register fields [15:0] are not locked */
  };
  PORT_SetPinConfig(PORTE, PIN29_IDX, &porte29_pinG15_config); /* PORTE29 (pin G15) is configured as FXIO0_D30 */
  const port_pin_config_t porte30_pinG17_config = {
    ...
    kPORT_OpenDrainEnable,                                   /* Open drain is enabled */
    kPORT_LowDriveStrength,                                  /* Low drive strength is configured */
    kPORT_MuxAlt7,                                           /* Pin is configured as FXIO0_D31 */
    kPORT_UnlockRegister                                     /* Pin Control Register fields [15:0] are not locked */
  };
  PORT_SetPinConfig(PORTE, PIN30_IDX, &porte30_pinG17_config); /* PORTE30 (pin G17) is configured as FXIO0_D31 */
}
