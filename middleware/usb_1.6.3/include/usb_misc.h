...
#define USB_LONG_FROM_LITTLE_ENDIAN_ADDRESS(n)                                            \
    ((uint32_t)(((uint32_t)((uint8_t)n[3]) << 24U) | ((uint32_t)((uint8_t)n[2]) << 16U) | \
                ((uint32_t)((uint8_t)n[1]) << 8U) | ((uint32_t)((uint8_t)n[0]) << 0U)))
...
#define USB_SHORT_FROM_LITTLE_ENDIAN_ADDRESS(n) \
    ((uint32_t)(((uint32_t)((uint8_t)n[1]) << 8U) | ((uint32_t)((uint8_t)n[0]) << 0U)))
...
#define USB_GLOBAL __attribute__((section(".bss.m_usb_global")))
#define USB_BDT __attribute__((section(".bss.m_usb_bdt")))
#define USB_RAM_ADDRESS_ALIGNMENT(n) __attribute__((aligned(n)))
...
#else
#define USB_DATA_ALIGNMENT USB_RAM_ADDRESS_ALIGNMENT(4)
#endif
